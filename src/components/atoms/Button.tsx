  ...
  'inline-flex items-center justify-center gap-2 rounded-xl font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-surface text-mid border border-light hover:bg-slate-50 dark:hover:bg-slate-800/60',
        ghost: 'bg-transparent text-mid hover:bg-slate-100 dark:hover:bg-slate-700',
